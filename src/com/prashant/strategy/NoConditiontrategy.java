...
public class NoConditiontrategy extends AbstractStrategy {
	

	private List<Position> positions;
	
	
	public final static Logger logger = Logger.getLogger(NoConditiontrategy.class);
	
	public static void main(String[] args) throws Exception, KiteException {

		
		
		NoConditiontrategy noConditiontrategy = new NoConditiontrategy();
		noConditiontrategy.createPosition();

		//noConditiontrategy.monitor();

	}
	
	public  NoConditiontrategy() {
	...
	private   List<OrderParams> getOrderParamsList () {
		...
		orderParams.quantity = 750;
		orderParams.orderType = Constants.ORDER_TYPE_LIMIT;
		orderParams.tradingsymbol = "NIFTY19N1411850CE";
	...
	OrderParams orderParams2 = new OrderParams();
		...
		orderParams2.tradingsymbol = "NIFTY19N1411800PE";
